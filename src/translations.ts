export const translations = {
  ...
  hi: {
    ...
    lupe: {
      description: "टिया लूप एक AI सहायक है जिसे LULAC और ACLU की जानकारी पर प्रशिक्षित किया गया है। वह आपके अधिकारों, आव्रजन प्रक्रियाओं और संयुक्त राज्य अमेरिका में कानूनी सुरक्षा के बारे में प्रश्नों का उत्तर दे सकती है।",
      startConversation: "वार्तालाप शुरू करें",
      endConversation: "वार्तालाप समाप्त करें",
      connected: "कनेक्टेड",
      disconnected: "डिस्कनेक्टेड",
      agentSpeaking: "एजेंट बोल रहा है",
      agentSilent: "एजेंट मौन है",
      micPermission: "वार्तालाप के लिए माइक्रोफोन की अनुमति आवश्यक है।",
      error: "वार्तालाप के दौरान एक त्रुटि हुई।",
      failedToStart: "वार्तालाप शुरू करने में विफल। कृपया पुनः प्रयास करें।"
    },
    redCardAudio: {
      preRecorded: "पूर्व-रिकॉर्ड की गई प्रतिक्रियाएँ",
      savedRecordings: "सहेजी गई रिकॉर्डिंग",
      copyLink: "लिंक कॉपी करें",
      copy: "कॉपी करें",
      errorPlaying: "ऑडियो चलाने में त्रुटि"
    },
    footer: {
    ...
    rights: {
      ...
      sections: {
        ...
        iceHome: {
          title: 'यदि ICE मेरे घर आता है तो क्या होगा',
          content: [
        ...
        iceStreet: {
          title: 'यदि ICE मुझे सड़क पर रोकता है तो क्या होगा',
          content: [
            'आपको चुप रहने का अधिकार है और आपको अपनी आव्रजन स्थिति पर चर्चा करने की आवश्यकता नहीं है',
  ...
  es: {
    protect: {
      ...
      preRecorded: 'Respuestas de Audio Pregrabadas',
      clickToPlay: 'Haz clic en un botón para reproducir una respuesta pregrabada en inglés.',
    ...
    redCard: {
      ...
      startRecording: 'Haga Clic para Iniciar Grabación',
      stopRecording: 'Detener Grabación',
      saving: 'Guardando...',
      recording: 'Grabando...',
      clickToStart: 'Haga clic en grabar para comenzar'
    },
    title: 'VÍGIA',
    ...
    showingAllPins: 'Mostrando todos los marcadores',
    showingActivePins: 'Mostrando solo marcadores activos de las últimas 24h',
    showingArchivedPins: 'Mostrando solo marcadores archivados',
      ...
      sections: {
        ...
        amendments: {
          ...
          content: [
            ...
            '• Una orden judicial es diferente de una orden de ICE: La orden judicial viene de un juez, mientras que la orden de ICE no',
            '• Protege tu privacidad, incluyendo a los inmigrantes',
            '',
            'Decimocuarta Enmienda:',
            '• Todos merecen procesos legales justos',
            '• Las leyes deben tratar a todos por igual, otorgando los mismos derechos a todos'
          ]
        },
        iceHome: {
        ...
        iceStreet: {
          title: 'Qué Hacer Si ICE Me Aborda en la Calle',
          content: [
            'Tienes derecho a guardar silencio y no tienes que discutir tu estatus migratorio',
  ...
  zh: {
    ...
    filterAll: '全部',
    archivedStatus: '已归档',
    showingAllPins: '显示所有标记',
    showingActivePins: '仅显示最近24小时内的活动标记',
    showingArchivedPins: '仅显示已归档标记',
    search: '搜索位置...',
    youAreHere: '你在这里',
    stillPresent: '仍在此处',
    notPresent: '不在此处',
    ...
    errors: {
      ...
      audio: {
        load: '加载音频文件失败。请稍后再试。',
        play: '播放音频失败。请重试。',
        recognition: '语音识别出错。请重试。',
        notSupported: '您的浏览器不支持语音识别。',
        recording: '访问麦克风出错。请检查权限。',
        processing: '处理音频出错。请重试。'
      }
    }
  }
};
